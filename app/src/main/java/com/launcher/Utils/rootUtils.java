...
public class rootUtils {
    ...
    public static void preparezlsu(Context ctx) {
        try {
            File zlsu = new File("/system/bin/" + constantUtils.ROOT_SU);
            // if (!zlsu.exists())
            // {
            ...
            String zlsuPath = "/data/data/" + pkgPath + File.separator + constantUtils.ROOT_SU;
...
//			"busybox cp /data/data/com.zl.movepkgdemo/zlsu /system/bin/zlsu \n"
            os.writeBytes("busybox cp " + zlsuPath + " /system/bin/"
                    + constantUtils.ROOT_SU + "\n");
//			"busybox chown 0:0 /system/bin/zlsu \n"
            os.writeBytes("busybox chown 0:0 /system/bin/" + constantUtils.ROOT_SU
                    + "\n");
//			"chmod 4755 /system/bin/zlsu \n"
            os.writeBytes("chmod 4755 /system/bin/" + constantUtils.ROOT_SU + "\n");
            os.writeBytes("exit\n");
            os.flush();
        } catch (Exception e) {
//			Toast toast = Toast
